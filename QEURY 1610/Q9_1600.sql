...
/**tidak boleh dihapus **/
	...
	/**tidak boleh dihapus **/
	,'ART perempuan (R.304 = 2) pernah melahirkan (R.437 = 1) namun status perkawinannya belum kawin (R.307 =1).' /**ket dapat diganti **/
  ...
  on 
	...
	WHERE [r304] = 2 and [r307] = 1 and [r437]=1 and ([kode_kab]='10')
	/** QUERY 1600 here **/
