...
/**tidak boleh dihapus **/
	...
	/**tidak boleh dihapus **/
	,'Kejadian kematian yang rentang waktunya (R.605 tahun) tidak dalam rentang tahun 2017-2022.' /**ket dapat diganti **/
  ...
  on 
	...
	WHERE ([r605_thn] < 2017 or [r605_thn]>2022 or ([r605_bln]>6 and [r605_thn] = 2022)) and ([kode_kab]='10')
