...
FROM (
	...
	WHERE ([r306]<10) and ([r303] = 4) and ([kode_kab]='11')
) anak
...
inner join (
	...
	FROM [SP2020C2_Validasi].[dbo].[C2_t_art]
	WHERE ([r303]=2 or [r303]=3) and ([kode_kab]='11')
) pasangan_krt on
	...
	WHERE ((anak.agama != krt.agama_krt) and (anak.agama!=pasangan_krt.agama_p_krt)) and (anak.[kode_kab]='11')
