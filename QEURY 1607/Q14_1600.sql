...
/**tidak boleh dihapus **/
	...
	/**tidak boleh dihapus **/
	,'Cek ART yang bahasa yang pertama kali dikuasai nya bahasa isyarat atau bahasa asing' /**ket dapat diganti **/
  ...
  on 
	...
	SELECT * FROM [SP2020C2_Validasi].[dbo].[C2_t_art] WHERE ([r423]>2) and ([kode_kab]='07')
