...
/**tidak boleh dihapus **/
	...
	/**tidak boleh dihapus **/
	,'Status komuter (R.427 = 1) namun R.428 sampai R.430 null.' /**ket dapat diganti **/
  ...
  on 
	...
	WHERE ([r427]=1) and (([r428a_kode]is null)or ([r428b_kode]is null) or ([r428c_kode]is null) or ([r429]is null) or ([r430]is null)) and ([kode_kab]='07')
	/** QUERY 1600 here **/
