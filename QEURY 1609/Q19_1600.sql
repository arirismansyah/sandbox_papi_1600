...
/**tidak boleh dihapus **/
	...
	/**tidak boleh dihapus **/
	,'Cek WNA tetapi bahasa pertamanya bahasa daerah atau bahasa isyarat' /**ket dapat diganti **/
  ...
  on 
	...
	SELECT * FROM [SP2020C2_Validasi].[dbo].[C2_t_art] WHERE ([r403]=2 and ([r423]=2 or [r423]=4)) and ([kode_kab]='09')
