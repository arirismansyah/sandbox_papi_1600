...
/**tidak boleh dihapus **/
	...
	/**tidak boleh dihapus **/
	,'ART pendidikannya tamat SD atau lebih tinggi namun tidak bisa berbahasa indonesia' /**ket dapat diganti **/
  ...
  on 
	...
	SELECT * FROM [SP2020C2_Validasi].[dbo].[C2_t_art] WHERE ([r431]>2 and [r422]=2) and ([kode_kab]='08')
